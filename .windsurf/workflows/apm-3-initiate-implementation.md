...
2. **Read .windsurf/workflows/apm-8-delegate-debug.md** - Follow the guide exactly
...
1. **Create Prompt:** Read and follow the appropriate delegation command from:
  - .windsurf/workflows/apm-8-delegate-debug.md for debugging issues
  - .windsurf/workflows/apm-7-delegate-research.md for information gathering
