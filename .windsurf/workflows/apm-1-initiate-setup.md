...
- If you have performed a long session and cannot recall the template perfectly, use your file tools to read .windsurf/workflows/apm-1-initiate-setup.md and retrieve it.
